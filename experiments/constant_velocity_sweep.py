...
def experiment_step(simulator):
    ...
    return simulator, kalman, mhe, vanilla_bpf, robust_bpfs
...
def run(runs, contamination):
    ...
    vanilla_bpf_data, robust_bpf_data, kalman_data, mhe_data = [], [], [], []
    for _ in trange(runs):
        simulator, kalman, mhe, vanilla_bpf, robust_bpfs = experiment_step(simulator)
    ...
    return np.array(kalman_data), np.array(mhe_data), np.array(vanilla_bpf_data), np.array(robust_bpf_data)
